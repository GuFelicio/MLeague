...
label_encoder_path = r"D:\NBHelp\noobHelp\venv\data\ML\label_encoder.pkl"
...
# Treinar e avaliar cada modelo com uma barra de progresso
results = {}
for model_name, model in tqdm(models.items(), desc="Treinando os modelos"):  # Adicionando barra de progresso
...
model_path = r"D:\NBHelp\noobHelp\venv\data\ML\best_model(2).pkl"
joblib.dump(best_model, model_path)

# Salvar as colunas usadas no treinamento
columns_path = r"D:\NBHelp\noobHelp\venv\data\ML\original_columns(2).pkl"
